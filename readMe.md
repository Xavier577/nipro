...
locally in my region(Nigeria). For more info on the project check the [Application.md](github/Xavier577/Nipro/documentation/Application.md) file in the documentation
directory
